...
MODEL_BASE_PATH="checkpoints/refcoco_5e_lr2e-4-bs128_r64_16/deepseek-vl-7b-chat/v1-20240917-165420/checkpoint-33925"
MODEL_SUFFIX="-merged"
...
if [ ! -d "$MODEL_PATH" ]; then
    ...
    CUDA_VISIBLE_DEVICES=0 swift export \
        ...
        --model_id_or_path "checkpoints/deepseek-vl-7b-chat" \
        --merge_lora true
fi
...
SPLIT_OPTIONS=("refcocog|umd|val")
