...
MODEL_BASE_PATH="checkpoints/refcoco_5e_lr2e-4-bs128_r64_16/internvl2-8b/v0-20240910-021121/checkpoint-33500"
MODEL_SUFFIX="-merged"
MODEL_PATH="${MODEL_BASE_PATH}${MODEL_SUFFIX}"
SAVE_FILE="output_eval/refcoco_5e_lr2e-4_bs128_r64_16/"
...
if [ ! -d "$MODEL_PATH" ]; then
    ...
    CUDA_VISIBLE_DEVICES=0 swift export \
        ...
        --model_id_or_path "/mnt/lustre/lanmengcheng.vendor/ms-swift/checkpoints/Intern-vl2-8b" \
        --merge_lora true
fi 
