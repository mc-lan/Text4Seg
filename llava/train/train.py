            ...
            if self.data_args.image_aspect_ratio == 'pad':
                ...
                def expand2square(pil_img, background_color):
                    ...
                    if width == height:
                        ...
                        result.paste(pil_img, ((height - width) // 2, 0))
                        return result
                if "crop_size" in self.list_data_dict[i]:
                    image = image.crop(self.list_data_dict[i]["crop_size"])
                if 'width' in self.list_data_dict[i]:
                    # w = int(self.list_data_dict[i]['width'])
                    # h = int(self.list_data_dict[i]['height'])
