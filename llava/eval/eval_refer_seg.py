...
from utils import AverageMeter, Summary, intersectionAndUnionGPU
# from test_crf import crf_refine 
# from cv2 import imread, imwrite

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset_split", type=str, default="refcoco|unc|testA")
    parser.add_argument("--save_file", type=str, default="llava/eval/ref_seg_results/llava-v1.5-7b-lora-r128-p16-e2/")
    ...
    for image_file in image_files:
        ...
        for i in range(num):
            ...
            # image = imread(os.path.join(image_file_path, f"{i}_image.png"))
            # pred_mask = crf_refine(image, np.array(pred_mask)//255)
