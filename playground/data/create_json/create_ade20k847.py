...
h_new = w_new = 32
images_path = "./playground/data/ADE847/images"
annotations_path = "./playground/data/ADE847/annotations"

labels = {}
with open("./playground/data/create_json/cls_ade20k847.txt") as f:
...
for _ in range(5):
    for image_file in os.listdir(images_path):
        ...
        item["image"] = "ADE847/images/" + image_file

        annotation = Image.open(os.path.join(annotations_path, image_file.replace(".jpg", ".tif")))
        ...
        labels_in_image = labels_in_image[labels_in_image != 65535]
        labels_not_in_image = [label for label in range(847) if label not in labels_in_image]
...
import json
with open("./playground/data/json_files/ade847_32_f_two_round_5.json", "w") as f:
