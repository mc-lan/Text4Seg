...
h_new = w_new = 32
images_path = "./playground/data/ADE20K/images"
annotations_path = "./playground/data/ADE20K/annotations"

labels = {}
with open("./playground/data/create_json/cls_ade20k.txt") as f:
...
for _ in range(5):
    for image_file in os.listdir(images_path):
        ...
        item["image"] = "ADE20K/images/" + image_file

        annotation = Image.open(os.path.join(annotations_path, image_file.replace(".jpg", ".png")))
        ...
        labels_not_in_image = [label for label in range(151) if label not in labels_in_image]
...
import json
with open("./playground/data/json_files/ade20k_32_f_two_round_5.json", "w") as f:
